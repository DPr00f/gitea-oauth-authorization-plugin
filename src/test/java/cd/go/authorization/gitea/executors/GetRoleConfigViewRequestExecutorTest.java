...
public class GetRoleConfigViewRequestExecutorTest {
    ...
    public void allFieldsShouldBePresentInView() throws Exception {
        ...
        final List<ProfileMetadata> metadataList = MetadataHelper.getMetadata(GiteaRoleConfiguration.class);
        ...
        assertThat("should contains only inputs that defined in GiteaRoleConfiguration.java", inputs, hasSize(metadataList.size()));
    }
