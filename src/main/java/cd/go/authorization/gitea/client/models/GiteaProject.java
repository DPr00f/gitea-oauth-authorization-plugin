...
public class GiteaProject {
    ...
    public GiteaProject(long id, String name) {
        this.id = id;
        this.name = name;
    }
    ...
    public static GiteaProject fromJSON(String json) {
        return GSON.fromJson(json, GiteaProject.class);
    }

    public static List<GiteaProject> fromJSONArray(String json) {
        final Type type = new TypeToken<List<GiteaProject>>() {
        }.getType();
