...
public class GiteaUser {
    ...
    public GiteaUser(String username, String name, String email) {
    ...
    public static GiteaUser fromJSON(String json) {
        return GSON.fromJson(json, GiteaUser.class);
    }
