...
import cd.go.authorization.gitea.exceptions.NoSuchRequestHandlerException;
import cd.go.authorization.gitea.executors.*;
import cd.go.authorization.gitea.requests.*;
...
import static cd.go.authorization.gitea.Constants.PLUGIN_IDENTIFIER;

@Extension
public class GitLabPlugin implements GoPlugin {
    public static final Logger LOG = Logger.getLoggerFor(GitLabPlugin.class);
