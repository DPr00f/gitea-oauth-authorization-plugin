...
import cd.go.authorization.gitea.models.Capabilities;
import cd.go.authorization.gitea.models.SupportedAuthType;
...
public class GetCapabilitiesRequestExecutor {
    ...
    Capabilities getCapabilities() {
        return new Capabilities(SupportedAuthType.Web, false, true, true);
    }
}
