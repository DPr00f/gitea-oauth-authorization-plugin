...
public class GiteaRole {
    ...
    private GiteaRoleConfiguration configuration;
    ...
    public GiteaRoleConfiguration roleConfiguration() {
    ...
    public static GiteaRole fromJSON(String json) {
        return GSON.fromJson(json, GiteaRole.class);
    }
}
