...
public class GitLabAuthenticator {
    ...
    public GitLabUser authenticate(TokenInfo tokenInfo, AuthConfig authConfig) throws IOException {
        return authConfig.gitLabConfiguration().gitLabClient().user(tokenInfo);
    }
